...
DEFAULT_EVENT_FORMATS: dict[str, str] = {
    ...
    "check_run": "{checkrun[name]} {action} check run with {checkrun[status]} in {repository[full_name]}",
    "check_suite": "",
    "code_scanning_alert": "{sender[login]} {action} code scanning alert in {repository[full_name]}",
    ...
    "custom_property": "{sender[login]} {action} custom property",
    "custom_property_values": "{sender[login]} {action} custom property",
    "delete": "{sender[login]} deleted {ref_type} ({ref}) in {repository[full_name]}",
    "dependabot_alert": "{sender[login]} {action} dependabot alert in {repository[full_name]}",
    "deploy_key": "{sender[login]} {action} deploy key in {repository[full_name]}",
    ...
    "projects_v2_item": "{sender[login]} {action} {projects_v2_item[content_type]} {projects_v2_item[content_node_id]} from {projects_v2_item[project_node_id]}",  # noqa: E501
    ...
    "secret_scanning_alert": "{sender[login]} {action} secret scanning alert in {repository[full_name]}",
